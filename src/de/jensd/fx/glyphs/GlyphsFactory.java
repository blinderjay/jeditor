...
public class GlyphsFactory {
    ...
    public Text createIcon(GlyphIcons icon) {
        ...
        return createIcon(icon, GlyphIcon.DEFAULT_FONT_SIZE,"black");
    }

    public Text createIcon(GlyphIcons icon, String iconSize,String color) {
        Text text = new Text(icon.unicode());
        text.getStyleClass().add("glyph-icon");
        text.setStyle(String.format("-fx-font-family: %s; -fx-font-size: %s;-fx-text-fill:%s;", icon.fontFamily(), iconSize,color));
        return text;
    }
...
//    }
    ...
    public void setIcon(Labeled labeled, GlyphIcons icon, ContentDisplay contentDisplay) {
        setIcon(labeled, icon, GlyphIcon.DEFAULT_FONT_SIZE, contentDisplay,"black");
    }

    public void setIcon(Labeled labeled, GlyphIcons icon, String iconSize) {
        setIcon(labeled, icon, iconSize, ContentDisplay.LEFT,"black");
    }
    
        public void setIcon(Labeled labeled, GlyphIcons icon, String iconSize,String color) {
        setIcon(labeled, icon, iconSize, ContentDisplay.LEFT,color);
    }

    public void setIcon(Labeled labeled, GlyphIcons icon, String iconSize, ContentDisplay contentDisplay,String color) {
        if (labeled == null) {
            throw new IllegalArgumentException("The component must not be 'null'!");
        }
        labeled.setGraphic(createIcon(icon, iconSize,color));
